...
u: (WRGP WPOB WBZR) (WR WP WB) (W1 W2 W3) (R1 P1 B1) (R2 P2 B2) (ZR GP OB) (GR OP ZB) (G1 O1 Z1) (P3 B3 R3) (R P B) (G O Z)
Rw: (WRGP+2 WBZR-1 YGRZ-1) (WR ZR GR) (R1 R2 R3) (W2 Z3 G1) (W3 Z1 G2) (GP WB ZY) (GY WP ZB) (P2 B1 Y2) (W1 Z2 G3) (W Z G) (P B Y)
r: (WRGP+2 WBZR-1 YGRZ-1) (WR ZR GR) (R1 R2 R3) (W2 Z3 G1) (W3 Z1 G2) (GP WB ZY) (GY WP ZB) (P2 B1 Y2) (W1 Z2 G3) (W Z G) (P B Y)
Lw: (WPOB+2 WRGP-1 YOPG-1) (WP GP OP) (P1 P2 P3) (W1 G1 O2) (W3 G3 O1) (WR GY OB) (WB GR OY) (W2 G2 O3) (B2 R1 Y1) (O W G) (B R Y)
l: (WPOB+2 WRGP-1 YOPG-1) (WP GP OP) (P1 P2 P3) (W1 G1 O2) (W3 G3 O1) (WR GY OB) (WB GR OY) (W2 G2 O3) (B2 R1 Y1) (O W G) (B R Y)
Bw: (WBZR+2 WPOB-1 YZBO-1) (WB OB ZB) (B1 B2 B3) (W1 O3 Z1) (W2 O1 Z2) (ZR WP OY) (ZY WR OP) (Z3 W3 O2) (Y3 R2 P1) (Z W O) (Y R P)
b: (WBZR+2 WPOB-1 YZBO-1) (WB OB ZB) (B1 B2 B3) (W1 O3 Z1) (W2 O1 Z2) (ZR WP OY) (ZY WR OP) (Z3 W3 O2) (Y3 R2 P1) (Z W O) (Y R P)
Fw: (WRGP-1 YGRZ+2 YOPG-1) (GP GR GY) (G1 G2 G3) (R1 Y2 P3) (R3 Y1 P2) (WP ZR OY) (WR ZY OP) (W3 Z3 O2) (R2 Y3 P1) (W Z O) (R Y P)
f: (WRGP-1 YGRZ+2 YOPG-1) (GP GR GY) (G1 G2 G3) (R1 Y2 P3) (R3 Y1 P2) (WP ZR OY) (WR ZY OP) (W3 Z3 O2) (R2 Y3 P1) (W Z O) (R Y P)
BRw: (WBZR-1 YZBO+2 YGRZ-1) (ZR ZB ZY) (Z1 Z2 Z3) (Y2 R2 B3) (Y3 R3 B1) (GY WR OB) (GR WB OY) (G2 W2 O3) (R1 B2 Y1) (G W O) (R B Y)
br: (WBZR-1 YZBO+2 YGRZ-1) (ZR ZB ZY) (Z1 Z2 Z3) (Y2 R2 B3) (Y3 R3 B1) (GY WR OB) (GR WB OY) (G2 W2 O3) (R1 B2 Y1) (G W O) (R B Y)
BLw: (WPOB-1 YOPG+2 YZBO-1) (OB OP OY) (O1 O2 O3) (P1 Y1 B3) (P3 Y3 B2) (WB GP ZY) (WP GY ZB) (B1 P2 Y2) (Z2 W1 G3) (Z W G) (B P Y)
bl: (WPOB-1 YOPG+2 YZBO-1) (OB OP OY) (O1 O2 O3) (P1 Y1 B3) (P3 Y3 B2) (WB GP ZY) (WP GY ZB) (B1 P2 Y2) (Z2 W1 G3) (Z W G) (B P Y)
...
eu: (WRGP WPOB WBZR) (WR WP WB) (W1 W2 W3) (R1 P1 B1) (R2 P2 B2) (ZR GP OB) (GR OP ZB) (G1 O1 Z1) (P3 B3 R3) (P B R) (G O Z)
er: (WRGP-1 YGRZ+2 YOPG-1) (GP GR GY) (G1 G2 G3) (R1 Y2 P3) (R3 Y1 P2) (WP ZR OY) (WR ZY OP) (W3 Z3 O2) (R2 Y3 P1) (R Y P) (W Z O)
el: (WPOB-1 YOPG+2 YZBO-1) (OB OP OY) (O1 O2 O3) (P1 Y1 B3) (P3 Y3 B2) (WB GP ZY) (WP GY ZB) (B1 P2 Y2) (Z2 W1 G3) (Z W G) (B P Y)
ef: (WPOB+2 WRGP-1 YOPG-1) (WP GP OP) (P1 P2 P3) (W1 G1 O2) (W3 G3 O1) (WR GY OB) (WB GR OY) (W2 G2 O3) (B2 R1 Y1) (B R Y) (W G O)
ebr: (WRGP+2 WBZR-1 YGRZ-1) (WR ZR GR) (R1 R2 R3) (W2 Z3 G1) (W3 Z1 G2) (GP WB ZY) (GY WP ZB) (P2 B1 Y2) (W1 Z2 G3) (W Z G) (P B Y)
ebl: (WBZR+2 WPOB-1 YZBO-1) (WB OB ZB) (B1 B2 B3) (W1 O3 Z1) (W2 O1 Z2) (ZR WP OY) (ZY WR OP) (Z3 W3 O2) (Y3 R2 P1) (Y R P) (Z W O)
eb: (WBZR-1 YZBO+2 YGRZ-1) (ZR ZB ZY) (Z1 Z2 Z3) (Y2 R2 B3) (Y3 R3 B1) (GY WR OB) (GR WB OY) (G2 W2 O3) (R1 B2 Y1) (R B Y) (G W O)
ed: (YOPG YGRZ YZBO) (GY ZY OY) (Y1 Y2 Y3) (G2 Z2 O2) (G3 Z3 O3) (GP ZR OB) (OP GR ZB) (O1 G1 Z1) (B3 P3 R3) (B P R) (O G Z)
H: (WRGP+2 WBZR+2 WPOB) (W1 W3 Z1) (W2 O1 G1)
Z: (WRGP+2 WBZR+2 WPOB) (W1 W3 Z1) (W2 O1 G1)
S: (WRGP+2 WPOB WBZR+2) (W1 W2 G1) (W3 O1 Z1)
Us: (ZR GP OB) (GR OP ZB) (R3 P3 B3) (G1 O1 Z1) (R P B) (G O Z)
Fs: (WR ZY OP) (WP ZR OY) (W3 Z3 O2) (P1 R2 Y3) (R Y P) (O W Z)
Rs: (WP ZB GY) (WB ZY GP) (W1 Z2 G3) (B1 Y2 P2) (P B Y) (G W Z)
Ls: (WR GY OB) (WB GR OY) (W2 G2 O3) (R1 Y1 B2) (R Y B) (G O W)
Uo: (WRGP WPOB WBZR) (WR WP WB) (W1 W2 W3) (R1 P1 B1) (R2 P2 B2) (YGRZ YOPG YZBO) (ZY GY OY) (Y3 Y2 Y1) (Z2 G2 O2) (Z3 G3 O3) (ZR GP OB) (GR OP ZB) (G1 O1 Z1) (P3 B3 R3) (R P B) (G O Z)
...
K: (R1 B2 B1)
W: (WRGP+2 WBZR+2 WPOB) (R1 R2 P1) (B1 B2 P2)
C: (P1 P2 R2)\
""")
...
2R: (U3 B7 D3 F3) (U5 B1 D5 F5) (U4 B8 D4 F4) (UF1+1 UB2+1 DB1+1 DF2+1)
2L: (U1 F1 D1 B5) (U7 F7 D7 B3) (U8 F8 D8 B4) (UB1+1 UF2+1 DF1+1 DB2+1)
2U: (FR1+1 FL2+1 BL1+1 BR2+1) (R1 F1 L1 B1) (R2 F2 L2 B2) (R3 F3 L3 B3)
2D: (R5 B5 L5 F5) (R6 B6 L6 F6) (R7 B7 L7 F7) (FR2+1 BR1+1 BL2+1 FL1+1)
2F: (U5 R7 D1 L3) (U7 R1 D3 L5) (U6 R8 D2 L4) (UL1+1 UR2+1 DR1+1 DL2+1)
2B: (U1 L7 D5 R3) (U3 L1 D7 R5) (U2 L8 D6 R4) (UR1+1 UL2+1 DL1+1 DR2+1)
s: (UL+1 UR+1 DR+1 DL+1) (U1 R3 D5 L7) (U3 R5 D7 L1) (U5 R7 D1 L3) (U7 R1 D3 L5) (U2 R4 D6 L8) (U4 R6 D8 L2) (U6 R8 D2 L4) (U8 R2 D4 L6) (UL1+1 UR2+1 DR1+1 DL2+1) (UR1+1 DR2+1 DL1+1 UL2+1) (R D L U)
m: (UF+1 DF+1 DB+1 UB+1) (U1 F1 D1 B5) (U3 F3 D3 B7) (U5 F5 D5 B1) (U7 F7 D7 B3) (U2 F2 D2 B6) (U4 F4 D4 B8) (U6 F6 D6 B2) (U8 F8 D8 B4) (UF1+1 DF2+1 DB1+1 UB2+1) (UB1+1 UF2+1 DF1+1 DB2+1) (F D B U)
e: (FR1+1 BR2+1 BL1+1 FL2+1) (R1 B1 L1 F1) (R2 B2 L2 F2) (R3 B3 L3 F3) (FR+1 BR+1 BL+1 FL+1) (R4 B4 L4 F4) (R B L F) (R8 B8 L8 F8) (R5 B5 L5 F5) (R6 B6 L6 F6) (R7 B7 L7 F7) (FR2+1 BR1+1 BL2+1 FL1+1)
S: (UL+1 UR+1 DR+1 DL+1) (U4 R6 D8 L2) (U8 R2 D4 L6) (R D L U)
M: (UF+1 DF+1 DB+1 UB+1) (U2 F2 D2 B6) (U6 F6 D6 B2) (F D B U)
E: (FR+1 BR+1 BL+1 FL+1) (R4 B4 L4 F4) (R B L F) (R8 B8 L8 F8)
rur: (UF UL UB FR) (URF+2 DFR+2 UFL ULB+2) (U1 F3 F5 U7) (U2 F4 U6 U8) (UF1+1 FR2 UF2 UL2+1) (UL1 UB1 FR1+1 DF2+1)
lul: (UF FL UB UR) (URF+2 DLF+2 UFL+2 UBR) (U3 U5 F7 F1) (U2 U4 U6 F8) (UF1 FL1+1 UF2+1 UR1) (UB2 UR2+1 DF1+1 FL2)""")
